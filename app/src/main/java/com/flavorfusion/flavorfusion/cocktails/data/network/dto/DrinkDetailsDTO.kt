...
data class DrinkDetailsDTO(
    ...
    @SerializedName("strInstructionsZH-HANS") val instructionsZH_HANS: String?,
    @SerializedName("strInstructionsZH-HANT") val instructionsZH_HANT: String?,
...
data class DrinkDetailsResponse(
    @SerializedName("drinks") val drinkDetails: List<DrinkDetailsDTO>
)
